...
export class ScheduleService {
  private apiUrl = 'https://medicareaipi-cpb5b9gmfmgbaeg7.swedencentral-01.azurewebsites.net/springsecurity/api/v1/providers';
  ...
  // Save the template
  saveWeeklySchedule(providerId: number, schedule: WeeklySchedule): Observable<any> {
    return this.http.put(`${this.apiUrl}/${providerId}/weekly-schedule`, schedule, { responseType: 'text' });
  }
  ...
  syncCalendar(providerId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/${providerId}/weekly-schedule/sync`, {}, { responseType: 'text' })
      .pipe(catchError(() => of('sync skipped')));
  }
