...
export class DoctorService {
  ...
  getAvailableSlots(doctorId: number, date: string): Observable<any[]> {
    ...
    return this.http.get<any[]>(`https://app-backend-medicareai-bvgteze4eugsdpgu.swedencentral-01.azurewebsites.net/springsecurity/api/v1/providers/${doctorId}/availabilities?from=${from}&to=${to}`);
  }
