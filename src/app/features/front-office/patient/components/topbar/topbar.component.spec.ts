...
import { PatientTopbarComponent } from './topbar.component';
...
describe('PatientTopbarComponent', () => {
  let component: PatientTopbarComponent;
  let fixture: ComponentFixture<PatientTopbarComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [PatientTopbarComponent],
      providers: [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PatientTopbarComponent);
